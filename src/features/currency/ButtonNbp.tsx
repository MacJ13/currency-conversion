...
const ButtonNbp = () => {
  ...
  return (
    <Button
      disabled={disabled}
      className="mt-3 bg-blue-500 relative hover:bg-blue-400 active:top-1 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded  opacity-100 disabled:opacity-50"
      onClick={() => {
        // console.log(nbpdata);
